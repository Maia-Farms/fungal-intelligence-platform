  ...
  return (
    <>
      ...
      <button
        ...
        tabIndex={0}
      >
        {/* Main card, overlay is now INSIDE the card, uses overflow-hidden for clipping */}
        <div className="bg-white min-w-[240px] border border-black rounded-lg shadow-md p-4 flex flex-col relative z-0 transition overflow-hidden">
          ...
          <div className="absolute inset-0 z-10 flex items-center justify-center pointer-events-none">
            <div className="opacity-0 group-hover:opacity-100 group-focus:opacity-100 transition-opacity duration-150
                            bg-black/60 w-full h-full flex flex-col gap-2 items-center justify-center pointer-events-auto">
              <div className="flex gap-4">
                {/* Edit Controls */}
                <button
                  className="px-4 py-2 text-xs 2xl:text-sm rounded bg-[#26bfa6] text-white font-halvar-regular font-semibold shadow hover:bg-[#173D3C] transition"
                  type="button"
                  tabIndex={-1}
                ...
                {/* View Reactor */}
                <button
                  className="px-4 py-2 text-xs 2xl:text-sm rounded bg-white text-[#173D3C] border-2 border-[#173D3C] font-halvar-regular font-semibold shadow hover:bg-[#173D3C] hover:text-white transition"
                  type="button"
                  tabIndex={-1}
      ...
      {dialogOpen && (
        <div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center">
          <div className="bg-white rounded-xl p-6 w-full max-w-xs shadow-lg flex flex-col">
            <h2 className="font-halvar-medium font-bold text-lg mb-4 text-[#173D3C] text-center">
              Edit Controls
            </h2>
